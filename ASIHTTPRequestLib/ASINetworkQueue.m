...
- (void)request:(__unused ASIHTTPRequest *)request didReceiveBytes:(long long)bytes
{
...
- (void)request:(__unused ASIHTTPRequest *)request didSendBytes:(long long)bytes
{
...
- (void)request:(__unused ASIHTTPRequest *)request incrementDownloadSizeBy:(long long)newLength
{
	[self setTotalBytesToDownload:[self totalBytesToDownload]+(unsigned long long)newLength];
}

- (void)request:(__unused ASIHTTPRequest *)request incrementUploadSizeBy:(long long)newLength
{
